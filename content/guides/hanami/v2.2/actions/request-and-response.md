...
The value set using `response.format` can either be a format name (`:json`) or a content type string (`"application/json"`). Consult [MIME types and formats](//page/formats-and-mime-types) for more information about setting response formats.
