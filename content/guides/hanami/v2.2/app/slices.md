...
- `"settings"` — the app’s [settings object](/v2.2/app/settings/)
- `"inflector"` — the app’s [inflector](/v2.2/app/inflector/)
...
See the [settings guide](/v2.2/app/settings/) for more information on settings.
